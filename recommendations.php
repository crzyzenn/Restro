<?php 
	...
	if (isset($_POST['itemName'])) {
		$results = $client->run("MATCH P = (N:USER)-[X:ORDERED]-(n) WHERE n.name = '".$_POST['itemName']."' WITH N as user MATCH G = (user)-[X:ORDERED]-(n) WHERE n.name <> '".$_POST['itemName']."' RETURN DISTINCT n");
	}
